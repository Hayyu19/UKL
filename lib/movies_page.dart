...
class MoviesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Map<String, String>> movies = [
      {"imagePath": "assets/musafa.jpg", "title": "Musafa", "ageRating": "SU"},
      {"imagePath": "assets/21.jpg", "title": "Moana", "ageRating": "SU"},
      {
        "imagePath": "assets/upcoming4.jpg",
        "title": "Cinta Dalam Ikhlas",
        "ageRating": "17+"
      },
      {
        "imagePath": "assets/show2.jpg",
        "title": "Petak Umpet",
        "ageRating": "15+"
      },
    ];
